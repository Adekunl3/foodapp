  ...
  return (
    <header className="fixed top-0 left-0 z-50 flex items-center justify-between w-full p-4 text-gray-700 bg-white shadow-md">
      ...
      <nav className="hidden space-x-4 md:flex">
        ...
        <a href="/store-location" className="block px-4 py-2 text-lg hover:text-red-500">location</a>
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-4">
          ...
          <a href="/store-location" onClick={closeMenu} className="block px-4 py-2 text-2xl transition-transform duration-300 ease-in-out transform hover:scale-105">location</a>
